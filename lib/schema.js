...
function getPostExcerpt(post) {
  ...
  return "ShedBody brings evidence-based workouts, fat loss strategies, yoga, and nutrition guidance into one practical fitness system built to help you transform your body with confidence.";
}
