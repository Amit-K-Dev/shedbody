...
export function generateStructuredInsights(unifiedTimeline, profile, activePlan) {
  ...
  for (const rule of rules) {
    ...
    try {
      if (rule.canEvaluate(unifiedTimeline, profile, activePlan)) {
        const insight = rule.evaluate(unifiedTimeline, profile, activePlan);
