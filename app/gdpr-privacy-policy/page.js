          ...
          <article className="max-w-2xl mx-auto space-y-8 text-gray-300 leading-relaxed">
            ...
            <header className="text-center space-y-4">
              ...
              <p className="max-w-2xl mx-auto text-lg">
                This GDPR Privacy Policy document contains types of information
                that is collected and recorded by ShedBody and how we use it.
              </p>
            </header>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 list-disc list-inside marker:text-green-400">
                ...
                <li>
                  Processing your personal information is in ShedBody legitimate
                  interests
                </li>
              ...
              <p>
                ShedBody will retain your personal information only for as long
                as is necessary for the purposes set out in this Privacy Policy.
                We&apos;ll retain and use your information to the extent
                necessary to accommodates our legal obligations, resolve
            ...
            <section className="space-y-4">
              ...
              <p>
                ShedBody follows a standard procedure of using log files. These
                log files visitors once they visit websites. All hosting
                ...
                possibly the time/number of clicks. These aren&apos;t linked to
                any information that&apos;s personally identifiable. The
                aim/purpose of the data/information is for analyzing trends,
                administering the site, tracking users&apos; movement on the web
                site, and gathering demographic information.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                cookies are accustomed store information including
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                advertising partners has their own Privacy Policy for his or her
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                automatically receive your IP address when this occurs/happens.
                These technologies are accustomed measure the effectiveness of
                their advertising campaigns and/or to personalize the
                advertising content that you just see on websites that you
                visit.
              </p>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                the respective Privacy Policies of those third-party ad servers
              ...
              <p>
                ...
                cookie management with specific web browsers, it may be found at
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                parents and guardians to watch/observe, participate in, and/or
              ...
              <p>
                ...
                your child provided this type of information/data on our
                website, we strongly encourage you to contact us immediately
                which we&apos;ll do our greatest efforts to promptly remove such
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                website with regards to the data that they shared and/or collect
                in ShedBody. This policy isn&apos;t applicable to any
