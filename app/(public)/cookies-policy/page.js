          ...
          <article className="max-w-2xl mx-auto space-y-8 text-gray-300 leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                your computer, to improve your experience. This page explains
                what information they collect, how we use it and why we
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                Unfortunately in most cases there are not any industry standard
                options for disabling cookies without completely disabling the
                functionality and features they add to this site. It&apos;s
                recommended that you just leave on all cookies if you&apos;re
                unsure whether you need them or not in case they&apos;re
                accustomed provide a service that you use.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                on your browser (see your browser Help for how to try and do
                this). Bear in mind that disabling cookies will affect the
                functionality of this and plenty of other websites that you
                visit. Disabling cookies will usually lead to also disabling
                certain functionality and features of the this website.
                Therefore it&apos;s recommended that you just don&apos;t disable
                cookies.
              </p>
              ...
              <p>
                ...
                delete the saved Cookies in your browser associated with this
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 pl-5 list-disc list-outside marker:text-green-400">
                <li>
                  ...
                  they may remain afterwards to remember your site preferences
                  when logged out.
                </li>
                <li>
                  <strong>Login related cookies:</strong> We use cookies when
                  you are logged in so that we can remember this fact. This
                  prevents you from having to log in every single time you visit
                  a new page. These cookies are typically removed or cleared
                  when you log out to ensure that you can only access restricted
                  features and areas when logged in.
                </li>
                <li>
                  <strong>Email newsletters related cookies:</strong> This site
                  offers newsletter or email subscription services and cookies
                  may be used to remember if you are already registered and
                  whether to show certain notifications which might only be
                  valid to subscribed/unsubscribed users.
                </li>
                <li>
                  <strong>Orders processing related cookies:</strong> This site
                  offers e-commerce or payment facilities and some cookies are
                  essential to ensure that your order is remembered between
                  pages so that we can process it properly.
                </li>
                <li>
                  <strong>Surveys related cookies:</strong> From time to time we
                  offer user surveys and questionnaires to provide you with
                  interesting insights, helpful tools, or to understand our user
                  base more accurately. These surveys may use cookies to
                  remember who has already taken part in a survey or to provide
                  you with accurate results after you change pages.
                </li>
                <li>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-2 pl-5 list-disc list-outside marker:text-green-400">
                ...
                <li>
                  ...
                  the site or pages you visit which helps us to understand how
                ...
                <li>
                  ...
                  ensuring we understand which optimizations our users
                  appreciate the most.
                </li>
                <li>
                  ...
                  to monitor our advertising and product costs to ensure the
                  best possible price.
                </li>
                <li>
                ...
                <li>
                  ...
                  tracking cookies simply allow us to see if our customers have
                  come to the site through one of our partner sites so that we
                  can credit them appropriately and where applicable allow our
                  affiliate partners to provide any bonus that they may provide
                ...
                <li>
                  ...
                  including; (Facebook, Instagram, Twitter, Pinterest, LinkedIn,
                  YouTube), will set cookies through our site which may be used
                  to enhance your profile on their site or contribute to the
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                features you use on this website.
              </p>
