        ...
        <div className="max-w-5xl mx-auto px-6">
          <article className="max-w-2xl mx-auto space-y-8 text-gray-300 leading-relaxed">
            ...
            <div className="space-y-4">
              ...
              <p>
                The types of information collected by ShedBody and its partners
                through the Services and the purposes for which We use it. How
                ShedBody collects, stores, and shares your information. Your
                rights with respect to such information collection.
              </p>

              <p>
                Your access to and use of the Services is subject to ShedBody’s
                Terms of Use (the “Terms”). Any capitalized term used, but not
                defined, means given in the terms in this Privacy Policy.
              </p>
              ...
              <p>
                <strong>Personal Information:</strong> “Personal Information” is
                information/data that can be used either directly or indirectly
                to identify an individual (you). Examples include name, email
                address, physical address, Internet protocol (IP) address,
                mobile ad ID, and your interactions with the Websites that are
                connected to other identifying information, such as name, email
                address, physical address, and Internet protocol IP address.
              </p>
            </div>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                to see if your browser accepts cookies. This cookie contains no
                personal data/information and is discarded once you close your
                browser.
              </p>
              ...
              <p>
                ...
                Login/signin cookies last for 2 days, and screen options cookies
                last for one year. If you choose/opt-in “Remember Me”, your
                login will persist for 2 weeks. If you sing/log out of your
                account, the login cookies are going to be removed.
              </p>
              ...
              <p>
                ...
                beacons. Below our advertising partners are listed. Each of our
                advertising partners has their own Privacy Policy for their
                policies on user data/information. For easier access, below we
                hyperlinked to their Privacy Policies.
              </p>
              ...
              <p>
                ...
                the advertising partners of ShedBody.
              </p>
              ...
              <p>
                ShedBody’s Privacy Policy does not apply to other advertisers or
                websites. Thus, we are advising you to consult the respective
                Privacy Policies of those third-party ad servers for more
                detailed information. It’s going to include their practices and
                instructions about how to (way to) opt-out of certain options.
                You may find a complete list of these Privacy Policies and their
                links: on visiting their site.
              </p>
              ...
              <p>
                ...
                management with specific web browsers, which can be found at the
              ...
              <p>
                ...
                children/kids/youngsters while using the internet. We encourage
                parents and guardians to observe/watch, participate in, and/or
              ...
              <p>
                ...
                If you think that your child /kids/youngsters provided this kind
                of information/data on our website, we strongly encourage you to
              ...
              <p>
                ...
                therewith embedded content, including tracking your interaction
                with the embedded content if you&apos;ve got an account and are
              ...
              <p>
                ...
                functionality of any supporting information provided by the
                authors. Any questions (other than missing material or content)
                should be directed to the respective author for the article.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                approve any follow-up comments automatically rather than holding
                them during a moderation queue.
              </p>

              <p>
                For users that register on our website (if any), we also store
                the private data/information they provide in their user profile.
                All users can see, edit, or delete their personal information at
                any time (except they can&apos;t change their username). Website
                administrators also can see/observe and edit that information.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                comments, you&apos;ll be able to request to receive an exported
                file of the private data we hold about you, including any data
                you&apos;ve got provided to us. you&apos;ll be able to also
                request that we erase any personal data we hold about you. This
                doesn&apos;t include any data we are obliged to stay for
